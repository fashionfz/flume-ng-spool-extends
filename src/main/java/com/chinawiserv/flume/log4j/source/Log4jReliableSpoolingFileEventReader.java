...
/**
 * @ClassName: Log4jReliableSpoolingFileEventReader
...
public class Log4jReliableSpoolingFileEventReader implements ReliableEventReader {
	...
	/**
		   ...
		   */
		  private Log4jReliableSpoolingFileEventReader(File spoolDirectory,
		      ...
		      ConsumeOrder consumeOrder, String pattern) throws IOException {
...
//					in);
			...
			EventDeserializer deserializer = new Log4jDeserializer(deserializerContext, in, pattern);
	...
	public static class Builder {
		...
		private String completedSuffix = Log4jSpoolDirectorySourceConfigurationConstants.SPOOLED_FILE_SUFFIX;
		private String ignorePattern = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_IGNORE_PAT;
		private String trackerDirPath = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_TRACKER_DIR;
		private Boolean annotateFileName = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_FILE_HEADER;
		private String fileNameHeader = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_FILENAME_HEADER_KEY;
		private Boolean annotateBaseName = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_BASENAME_HEADER;
		private String baseNameHeader = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_BASENAME_HEADER_KEY;
		private String deserializerType = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_DESERIALIZER;
		private Context deserializerContext = new Context();
		private String deletePolicy = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_DELETE_POLICY;
		private String inputCharset = Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_INPUT_CHARSET;
		private DecodeErrorPolicy decodeErrorPolicy = DecodeErrorPolicy.valueOf(
				Log4jSpoolDirectorySourceConfigurationConstants.DEFAULT_DECODE_ERROR_POLICY.toUpperCase(Locale.ENGLISH));
		private ConsumeOrder consumeOrder = SpoolDirectorySourceConfigurationConstants.DEFAULT_CONSUME_ORDER;
		
		private String pattern = Log4jSpoolDirectorySourceConfigurationConstants.DATE_PATTERN;
		...
		public Log4jReliableSpoolingFileEventReader build() throws IOException {
			return new Log4jReliableSpoolingFileEventReader(spoolDirectory, completedSuffix, ignorePattern, trackerDirPath,
					annotateFileName, fileNameHeader, annotateBaseName, baseNameHeader, deserializerType,
					deserializerContext, deletePolicy, inputCharset, decodeErrorPolicy, consumeOrder, pattern);
		}
	}
